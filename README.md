...
To recognize the support of industry, governement and non-profit organizations to the UBC NLP group, please add the logo of the supporting entity under ./img/sponsors. By adding the image (ideally close to square-sized) in this folder, the sponsor will automatically appear in the website footer. Similarly, removing the image from the folder will remove the sponsor from the website.
